 ...
 */
	public function testFetchRowColumnParsing() {
		$this->loadFixtures('Users');
		$sql = 'SELECT "Users"."id", "Users"."user", "Users"."password", "Users"."created", (1 + 1) AS "two" ' .
			'FROM "users" AS "Users" WHERE ' .
			'"Users"."id" IN (SELECT MAX("id") FROM "users") ' .
			'OR "Users.id" IN (5, 6, 7, 8)';
		...
		$sql = 'SELECT "Users"."id", "Users"."user" ' .
			'FROM "users" AS "Users" WHERE "Users"."id" = 4 ' .
			'UNION ' .
			'SELECT "Users"."id", "Users"."user" ' .
			'FROM "users" AS "Users" WHERE "Users"."id" = 3';
		$result = $this->Dbo->fetchRow($sql);
