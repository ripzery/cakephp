 ...
 */
	public function testCounterCacheSkip() {
		...
		$users = $User->find('all', array('order' => 'Users.id'));
		$this->assertEquals(2, $users[0]['Users']['post_count']);
		$this->assertEquals(1, $users[1]['Users']['post_count']);
	}
 ...
 */
	public function testSaveAll() {
		$this->loadFixtures('Posts', 'Author', 'Comment', 'Attachment', 'Article', 'Users');
		$TestModel = new Post();
 ...
 */
	public function testSafeUpdateMode() {
		...
		$users = $User->find('list', array('fields' => 'Users.user'));
