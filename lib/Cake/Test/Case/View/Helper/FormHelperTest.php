 ...
 */
	public function testInput() {
		...
		$this->Form->request->data = array('Contact' => array('phone' => 'Hellos & World > weird chars'));
		...
		$expected = array(
			...
			array('input' => array(
				...
				'value' => 'Hellos &amp; World &gt; weird chars',
 ...
 */
	public function testInputMagicTypeDoesNotOverride() {
		...
		$expected = array(
			...
			'label' => array('for' => 'ModelUser'), 'Users', '/label',
			'/div'
		);
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testFormInputs() {
		...
		$this->Form->create('Contact');
		$result = $this->Form->inputs(array('fieldset' => false, 'legend' => 'Hellos'));
		$expected = array(
			'input' => array('type' => 'hidden', 'name' => 'data[Contact][id]', 'id' => 'ContactId'),
			array('div' => array('class' => 'input text')),
			'*/div',
		...
		$this->Form->create('Contact');
		$result = $this->Form->inputs(null, null, array('fieldset' => false, 'legend' => 'Hellos'));
		$this->assertTags($result, $expected);

		$this->Form->create('Contact');
		$result = $this->Form->inputs('Hellos');
		$expected = array(
			'fieldset' => array(),
			'legend' => array(),
			'Hellos',
		...
		$this->Form->create('Contact');
		$result = $this->Form->inputs(array('legend' => 'Hellos'));
		$expected = array(
			'fieldset' => array(),
			'legend' => array(),
			'Hellos',
		...
		$this->Form->create('Contact');
		$result = $this->Form->inputs(null, null, array('legend' => 'Hellos'));
		$this->assertTags($result, $expected);
		$this->Form->end();
 ...
 */
	public function testCheckboxZeroValue() {
		$result = $this->Form->input('Users.get_spam', array(
			'type' => 'checkbox',
			'value' => '0',
			'hiddenField' => '1',
		));
		$expected = array(
			'div' => array('class' => 'input checkbox'),
			array('input' => array(
				'type' => 'hidden', 'name' => 'data[Users][get_spam]',
				'value' => '1', 'id' => 'UserGetSpam_'
			)),
			array('input' => array(
				'type' => 'checkbox', 'name' => 'data[Users][get_spam]',
 ...
 */
	public function testPostLinkAfterGetForm() {
		$this->Form->request->params['_Token']['key'] = 'testkey';
		$this->Form->create('Users', array('type' => 'get'));
		$this->Form->end();
