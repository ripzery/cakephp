 ...
 */
	public function testMethodDispatching() {
		...
		$this->object->oneParamMethod('Hellos');
		$expected[] = array('oneParamMethod' => array('Hellos'));
		$this->assertSame($expected, $this->object->methodCalls);
		...
		$this->object->dispatchMethod('oneParamMethod', array('Hellos'));
		$expected[] = array('oneParamMethod' => array('Hellos'));
		$this->assertSame($expected, $this->object->methodCalls);
		...
		$this->object->dispatchMethod('methodWithOptionalParam', array('Hellos'));
		$expected[] = array('methodWithOptionalParam' => array("Hellos"));
		$this->assertSame($expected, $this->object->methodCalls);
